                              ...
                              <div className="text-center">
                                <div className="progress mb-1" style={{height: '6px'}}>
                                  <div 
                                    ...
                                    style={{width: `${(scores.earthquake.score/scores.earthquake.maxScore)*100}%`}}
                                  ></div>
                                </div>
                            ...
                            {scores.fireDrill && (
                              <div className="text-center">
                                <div className="progress mb-1" style={{height: '6px'}}>
                                  <div 
                                    className="progress-bar bg-success" 
                                    style={{width: `${(scores.fireDrill.score/scores.fireDrill.maxScore)*100}%`}}
                                  ></div>
                                </div>
                                <small className="text-success">
                            ...
                            {scores.flood && (
                              <div className="text-center">
                                <div className="progress mb-1" style={{height: '6px'}}>
                                  <div 
                                    className="progress-bar bg-success" 
                                    style={{width: `${(scores.flood.score/scores.flood.maxScore)*100}%`}}
                                  ></div>
                                </div>
                                <small className="text-success">
                            ...
                            {scores.cyclone && (
                              <div className="text-center">
                                <div className="progress mb-1" style={{height: '6px'}}>
                                  <div 
                                    className="progress-bar bg-success" 
                                    style={{width: `${(scores.cyclone.score/scores.cyclone.maxScore)*100}%`}}
                                  ></div>
                                </div>
                                <small className="text-success">
                            ...
                            {scores.landslide && (
                              <div className="text-center">
                                <div className="progress mb-1" style={{height: '6px'}}>
                                  <div 
                                    className="progress-bar bg-success" 
                                    style={{width: `${(scores.landslide.score/scores.landslide.maxScore)*100}%`}}
                                  ></div>
                                </div>
                                <small className="text-success">
                        ...
                        <div className="text-center text-muted">
                          ...
                          <div className="mt-3">
                            <div className="progress" style={{height: '8px'}}>
                              <div className="progress-bar bg-info" style={{width: '0%'}}></div>
                            </div>
                          ...
                          <div className="mt-4 p-3 bg-primary text-white rounded">
                            ...
                            <div className="progress mt-2" style={{height: '8px'}}>
                              <div 
                                ...
                                style={{width: `${(Object.keys(scores).length/2)*100}%`}}
                              ></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="progress" style={{height: '8px'}}>
                          <div 
                            ...
                            style={{width: `${(overallStats.completedActivities/overallStats.totalActivities)*100}%`}}
                          ></div>
                        </div>
                      </div>
                    </div>
