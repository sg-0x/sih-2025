            ...
            <div className="row g-3">
              <div className="col-12 col-md-6">
                <div className="border rounded-3 p-3 h-100">
                  ...
                  <button className="btn btn-primary btn-sm" type="button" aria-label="Assign recommended module to selected classes"><i className="bi bi-send me-1"></i>Assign to classes</button>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="border rounded-3 p-3 h-100">
                  ...
                  <button className="btn btn-success btn-sm" type="button" aria-label="Confirm scheduled drill slot"><i className="bi bi-calendar-check me-1"></i>Confirm drill</button>
                </div>
              </div>
            </div>
            )}
