      ...
      return [
        {
          ...
          files: {
            video: {
              ...
              size: 15728640,
              type: "video/mp4",
              url: `${process.env.REACT_APP_API_URL?.replace('/api', '') || 'http://localhost:5000'}/uploads/earthquake-safety-basics.mp4`
            },
            pdf: {
              ...
              url: `${process.env.REACT_APP_API_URL?.replace('/api', '') || 'http://localhost:5000'}/uploads/earthquake-safety-guide.pdf`
            }
          },
        ...
        },
        {
          ...
          files: {
            video: {
              ...
              size: 25165824,
              type: "video/mp4",
              url: `${process.env.REACT_APP_API_URL?.replace('/api', '') || 'http://localhost:5000'}/uploads/fire-evacuation-procedures.mp4`
            }
          },
          type: "module_assignment",
          status: "active",
