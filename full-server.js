// Full-featured server with React build support
console.log('🚀 Starting full-featured server...');
...
app.get('/api/test', (req, res) => {
  ...
  res.json({ 
    message: 'Full-featured server is responding!',
...
app.get('/', (req, res) => {
  ...
  if (process.env.NODE_ENV === 'production') {
    ...
    res.json({ 
      message: 'Full-featured server is running!',
      status: 'OK',
      timestamp: new Date().toISOString(),
      port: PORT
    });
...
const server = app.listen(PORT, '::', () => {
  console.log(`✅ Full-featured server running on http://[::]:${PORT}`);
